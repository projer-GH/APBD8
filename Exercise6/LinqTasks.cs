...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        public static IEnumerable<Emp> Task1()
        {
            ...
            result = from res in Emps where (res.Job.Equals("Backend programmer")) select res;
        ...
        public static IEnumerable<Emp> Task2()
        {
            ...
            result = from res in Emps
                where (res.Job.Equals("Frontend programmer") && res.Salary > 1000)
                orderby res.Ename descending 
                select res;
        ...
        public static IEnumerable<Emp> Task4()
        {
            ...
            result = from res in Emps where (res.Salary == Emps.Max(emp => emp.Salary)) select res;
        ...
        public static IEnumerable<object> Task5()
        {
            ...
            result = Emps.Select(res => new { Nazwisko = res.Ename, Praca = res.Job });
        ...
        public static IEnumerable<object> Task7()
        {
            ...
            result = Emps.GroupBy(x => x.Job).Select(x => new { Praca = x.Key, LiczbaPracownikow = x.Count() });
        ...
        public static Emp Task9()
        {
            ...
            result = Emps.Where(x => x.Job == "Frontend programmer").MaxBy(x => x.HireDate);
        ...
        public static int Task13(int[] arr)
        {
            ...
            result = arr.GroupBy(num => num).Where(group => group.Count() % 2 == 1).Select(e => e.Key).First();
            return result;
        }
        ...
        public static IEnumerable<Dept> Task14()
        {
            ...
            result = Depts.Where(x => Emps.Count(y => y.Deptno == x.Deptno) == 5 || Emps.Count(y => y.Deptno == x.Deptno) == 0)
                .OrderBy(x => x.Dname);
